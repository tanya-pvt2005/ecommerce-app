            ...
            <div className='flex items-center justify-between py-5 font-medium'>
                ...
                <div className='flex items-center gap-6'>
                    ...
                    <div className='group relative'>
                        ...
                        {/* drop down menu on hovering profile */}
                    ...
                    <img src={assets.menu_icon} className='w-5 cursor-pointer sm:hidden' onClick={() => setVisible(true)}></img>
                </div>

                {/* SideBar menu for small screens, dynamic className due t0 state var */}
